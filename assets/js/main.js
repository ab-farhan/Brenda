...
$(function () {
	...
	$("#RegisterFrom").validate({
		...
		messages: {
			r_fname: "Please enter your first name!",
			r_lname: "Please enter your last name!",
			r_email: {
				required: "Please ener your email address!",
				email: "Enter your valid email!",
			},
			r_pass: {
				required: "Please enter your password!",
				minlength: "Password minimum 6 charecter or more!",
			},
			r_cpass: {
	...
	$("#loginFrom").validate({
		...
		messages: {
			...
			l_pass: "PLease enter your password!",
	...
	$("#con_from").validate({
		...
		messages: {
			...
			c_email:{
				...
				email:"Please enater a valid email!",
			},
			c_message:"Please leave a message!",
		},
		submitHandler: function (form) {
			form.submit();
		}

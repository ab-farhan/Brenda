 ...
 if(!empty($_POST)){
   ...
   if(!empty($name)){
     if(!empty($details)){
                 ...
                 if($image['name']!=""){
                     $imageName="feature-".time()."-".rand(1000,10000000).".".pathinfo($image['name'],PATHINFO_EXTENSION);
                   }else {
                     echo "<h4 class='text-center text-warning pt-3'>Upload Your Image Letter</h4>";
                   }
                     $insert="INSERT INTO service(ser_title,ser_subtitle,ser_name,ser_details,ser_img)
                   VALUES('$title','$subtirle','$name','$details','$imageName')";
         ...
         echo "<h4 class='text-center text-danger pt-3'>Please Service Details Details</h4>";
       }
     }else {
       echo "<h4 class='text-center text-danger pt-3'>Please enter Service Name </h4>";
     }
 }
 ?>
											...
											<div class="row">
												<div class="col-md-8">
													<div class="card_header_title text-left">
														...
														<h5 class="d-inline-block">ADD FEATURE</h5>
													</div>
												</div>
                      ...
                      <div class="form-group row custom_form">
										...
										<div class="card-footer text-muted text-center">
											<button type="submit" class="btn btn-sm btn-dark submit_btn">ADD FEATURE</button>
										</div>
									</div>
								</form>
							</div>
